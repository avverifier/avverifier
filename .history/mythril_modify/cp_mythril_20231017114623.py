...
def get_contract_code(w3, contract_address):
    api_key = 'G9SUN7614RH4Q9GQFHI235QJX9I7JI92NE'
...
def main():
    w3 = Web3(Web3.HTTPProvider('https://late-old-season.discover.quiknode.pro/4ac82a377cf0ab2e7cb575408418d25f951ea0e3/'))
